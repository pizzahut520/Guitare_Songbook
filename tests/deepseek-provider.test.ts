...
describe("DeepSeek semantic SSE provider with mocked fetch", () => {
  ...
  it("returns no_output_text when completed has no assistant output_text", async () => {
    ...
    expect(log).toHaveBeenCalledWith({
      ...
      output_item_message_events: 0,
      output_item_web_search_events: 0,
      output_item_reasoning_events: 0,
      output_item_other_events: 0,
      completed_response_message_items: 0,
      completed_response_web_search_items: 0,
      completed_response_reasoning_items: 1,
      completed_response_other_items: 0,
